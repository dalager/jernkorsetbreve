...
import { PlacePhoto } from "@/types/letters";
...
export default function PlaceImages({ photos }: PlaceImagesProps) {
          ...
          return (
            ...
            >
              ...
              <div className="px-2 py-2">
                ...
                {photo.category && (
                  <p className="font-ui text-xs text-faded/70 mt-1 uppercase tracking-wide">
                    {photo.category}
                  </p>
                )}
              </div>
