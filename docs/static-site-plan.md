...
**Base**: `webapp/public-site/` — Next.js 15 with `output: "export"`
...
### Generated Static Data (`webapp/public-site/public/data/`)
| File | Size | Purpose |
|------|------|---------|
...
```json
{
  ...
  "dev": "cd webapp/public-site && npm run dev",
  "build": "npm run data:all && cd webapp/public-site && npm run build",
  "preview": "npx serve webapp/public-site/out"
}
```
...
| `leaflet` + `react-leaflet` | Interactive map | webapp/public-site |
